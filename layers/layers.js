...
//ol.proj.get("EPSG:32632").setExtent([673800.171903, 4913278.476198, 698912.671903, 4942451.859122]);
var wms_layers = [];
...
var lyr_TemperaturaSuperficiale = new ol.layer.Image({
    ...
    title: '<div id="layertitle">Temperatura superficiale<br />\
        <i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend">\
        <img src="styles/legend/TemperaturaSuperficiale_0.png"/><= 20<br />\
        <img src="styles/legend/TemperaturaSuperficiale_10.png"/>23<br />\
        <img src="styles/legend/TemperaturaSuperficiale_20.png"/>27<br />\
        <img src="styles/legend/TemperaturaSuperficiale_30.png"/>30<br />\
        <img src="styles/legend/TemperaturaSuperficiale_40.png"/>33<br />\
        <img src="styles/legend/TemperaturaSuperficiale_50.png"/>37<br />\
        <img src="styles/legend/TemperaturaSuperficiale_60.png"/>40<br />\
        <img src="styles/legend/TemperaturaSuperficiale_70.png"/>43<br />\
        <img src="styles/legend/TemperaturaSuperficiale_80.png"/>46<br />\
        <img src="styles/legend/TemperaturaSuperficiale_90.png"/>50<br />\
        <img src="styles/legend/TemperaturaSuperficiale_99.png"/>> 53<br /></a>'
        });
...
var lyr_FiltrodiPopolazione2025 = new ol.layer.Image({
    ...
    title: '<div id="layertitle">Filtro di popolazione<br />\
        <i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend">\
...
var lyr_Indicedivulnerabilitsanitaria = new ol.layer.Image({
    ...
    title: '<div id="layertitle">Indice di vulnerabilità sanitaria<br />\
        <i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend">\
        <img src="styles/legend/Indicedivulnerabilitsanitaria_0.png"/>0<br />\
        <img src="styles/legend/Indicedivulnerabilitsanitaria_1.png"/>99.99° percentile<br />\
        <img src="styles/legend/Indicedivulnerabilitsanitaria_2.png"/>massimo valore<br /></a>'
        });
...
var lyr_CasedellaComunitcensite = new ol.layer.Vector({
    title: '<div class="roller-switcher"></div> CasedellaComunitcensite',
    source: new ol.source.Vector(), 
    sourceType: 'json',
    permalink: "CasedellaComunitcensite",
    popuplayertitle: 'Case della Comunità censite',
    creationdate: '2026-07-03 16:28:51',
    interactive: true,
});
function load_CasedellaComunitcensite_data() {
    var format_CasedellaComunitcensite = new ol.format.GeoJSON();
    var features_CasedellaComunitcensite = format_CasedellaComunitcensite.readFeatures(json_CasedellaComunitcensite, 
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32632'});
    var jsonSource_CasedellaComunitcensite = new ol.source.Vector({
    attributions:
    '<a class="legend"><b>Case della Comunità censite</b><br />\
        <img src="styles/legend/CasedellaComunitcensite_0.png"/>HUB<br />\
        <img src="styles/legend/CasedellaComunitcensite_1.png"/>N/A<br />\
        <img src="styles/legend/CasedellaComunitcensite_2.png"/>SPOKE<br /></a>'
        });
    lyr_CasedellaComunitcensite.setSource(jsonSource_CasedellaComunitcensite);
    lyr_CasedellaComunitcensite.set(
    "title", '<div id="layertitle">Case della Comunità censite<br />\
        <i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend">\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="HUB" checked><img src="styles/legend/CasedellaComunitcensite_0.png"/>HUB<br />\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="N/A" checked><img src="styles/legend/CasedellaComunitcensite_1.png"/>N/A<br />\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="SPOKE" checked><img src="styles/legend/CasedellaComunitcensite_2.png"/>SPOKE<br /></a>'
        );
    var featureCounter_CasedellaComunitcensite = 1;
    jsonSource_CasedellaComunitcensite.on('addfeature', function (event) {
        var feature = event.feature;
        feature.set("idO", featureCounter_CasedellaComunitcensite++);
        feature.set("layerObject", lyr_CasedellaComunitcensite);
    });        
    jsonSource_CasedellaComunitcensite.addFeatures(features_CasedellaComunitcensite);
}
applySLDstyle(lyr_CasedellaComunitcensite, style_CasedellaComunitcensite, 'Case della Comunità censite');
...
var lyr_SistemaEmergenzaUrgenza = new ol.layer.Vector({
    title: '<div class="roller-switcher"></div> SistemaEmergenzaUrgenza',
    source: new ol.source.Vector(), 
    sourceType: 'json',
    permalink: "SistemaEmergenzaUrgenza",
    popuplayertitle: 'Sistema Emergenza-Urgenza',
    creationdate: '2026-07-03 16:28:51',
    interactive: true,
});
function load_SistemaEmergenzaUrgenza_data() {
    var format_SistemaEmergenzaUrgenza = new ol.format.GeoJSON();
    var features_SistemaEmergenzaUrgenza = format_SistemaEmergenzaUrgenza.readFeatures(json_SistemaEmergenzaUrgenza, 
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32632'});
    var jsonSource_SistemaEmergenzaUrgenza = new ol.source.Vector({
    attributions:
    '<a class="legend"><b>Sistema emergenza-urgenza</b><br />\
        <img src="styles/legend/SistemaEmergenzaUrgenza_0.png"/>DEA II livello<br />\
        <img src="styles/legend/SistemaEmergenzaUrgenza_1.png"/>DEA I livello<br />\
        <img src="styles/legend/SistemaEmergenzaUrgenza_2.png"/>Pronto Soccorso<br />\
        <img src="styles/legend/SistemaEmergenzaUrgenza_3.png"/>Punto di Primo Intervento<br /></a>'
        });
    lyr_SistemaEmergenzaUrgenza.setSource(jsonSource_SistemaEmergenzaUrgenza);
    lyr_SistemaEmergenzaUrgenza.set(
    "title", '<div id="layertitle">Sistema emergenza-urgenza<br />\
        <i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend">\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="DEA II livello" checked><img src="styles/legend/SistemaEmergenzaUrgenza_0.png"/>DEA II livello<br />\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="DEA I livello" checked><img src="styles/legend/SistemaEmergenzaUrgenza_1.png"/>DEA I livello<br />\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="Pronto Soccorso" checked><img src="styles/legend/SistemaEmergenzaUrgenza_2.png"/>Pronto Soccorso<br />\
        <input type="checkbox" class="symbology" symbology-type="categorized" value="Punto di Primo Intervento" checked><img src="styles/legend/SistemaEmergenzaUrgenza_3.png"/>Punto di Primo Intervento<br /></a>'
        );
    var featureCounter_SistemaEmergenzaUrgenza = 1;
    jsonSource_SistemaEmergenzaUrgenza.on('addfeature', function (event) {
        var feature = event.feature;
        feature.set("idO", featureCounter_SistemaEmergenzaUrgenza++);
        feature.set("layerObject", lyr_SistemaEmergenzaUrgenza);
    });        
    jsonSource_SistemaEmergenzaUrgenza.addFeatures(features_SistemaEmergenzaUrgenza);
}
applySLDstyle(lyr_SistemaEmergenzaUrgenza, style_SistemaEmergenzaUrgenza, 'Sistema Emergenza-Urgenza');
...
function load_Comuni2026_data() {
    ...
    lyr_Comuni2026.set(
    "title", '<img src="styles/legend/Comuni2026.png"/>Comuni'
    );
...
function load_SezionidiCensimento2021_data() {
    ...
    attributions:'<a class="legend"><img src="styles/legend/SezionidiCensimento2021.png"/><b>Sezioni di Censimento</b>'
    });
    lyr_SezionidiCensimento2021.setSource(jsonSource_SezionidiCensimento2021);
    lyr_SezionidiCensimento2021.set(
    "title", '<img src="styles/legend/SezionidiCensimento2021.png"/>Sezioni di Censimento'
    );
...
var group_Edificipubblici = new ol.layer.Group({
                                layers: [group_PuntidiinteresseOSM,lyr_Presidisocioassistenzialianziani,lyr_CasedellaComunitcensite,lyr_OspedaliCensiti,lyr_SistemaEmergenzaUrgenza,],
                                openInLayerSwitcher: false,
                                title: 'Infrastrutture socio-sanitarie e contesto'});
...
lyr_CasedellaComunitcensite.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', 'Tipo': 'Tipo', });
lyr_OspedaliCensiti.set('fieldAliases', {'fid': 'fid', 'Denominazione_1': 'Denominazione_1', 'Indirizzo.completo': 'Indirizzo.completo', 'Macrotipologia': 'Macrotipologia', 'Tipologia': 'Tipologia', 'Dip.emergenza': 'Dip.emergenza', });
lyr_SistemaEmergenzaUrgenza.set('fieldAliases', {'fid': 'fid', 'Denominazione_1': 'Denominazione_1', 'Indirizzo.completo': 'Indirizzo.completo', 'Macrotipologia': 'Macrotipologia', 'Tipologia': 'Tipologia', 'Dip.emergenza': 'Dip.emergenza', });
...
lyr_EdificieStruttureOSM.set('fieldImages', {'fid': 'TextEdit', 'fclass': 'TextEdit', 'name': 'TextEdit', 'type': 'TextEdit', 'osm_id': 'TextEdit', 'code': 'Range', 'layer': 'TextEdit', 'path': 'TextEdit', 'CLUSTER_ID': 'Range', 'CLUSTER_SIZE': 'Range', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_CasedellaComunitcensite.set('fieldImages', {'fid': 'TextEdit', 'Nome': 'TextEdit', 'Tipo': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
lyr_OspedaliCensiti.set('fieldImages', {'fid': 'TextEdit', 'Denominazione_1': 'TextEdit', 'Indirizzo.completo': 'TextEdit', 'Macrotipologia': 'TextEdit', 'Tipologia': 'TextEdit', 'Dip.emergenza': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
lyr_SistemaEmergenzaUrgenza.set('fieldImages', {'fid': 'TextEdit', 'Denominazione_1': 'TextEdit', 'Indirizzo.completo': 'TextEdit', 'Macrotipologia': 'TextEdit', 'Tipologia': 'TextEdit', 'Dip.emergenza': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_CasedellaComunitcensite.set('fieldLabels', {'fid': 'hidden field', 'Nome': 'no label', 'Tipo': 'no label', });
lyr_OspedaliCensiti.set('fieldLabels', {'fid': 'hidden field', 'Denominazione_1': 'no label', 'Indirizzo.completo': 'no label', 'Macrotipologia': 'no label', 'Tipologia': 'no label', 'Dip.emergenza': 'hidden field', });
lyr_SistemaEmergenzaUrgenza.set('fieldLabels', {'fid': 'hidden field', 'Denominazione_1': 'no label', 'Indirizzo.completo': 'no label', 'Macrotipologia': 'hidden field', 'Tipologia': 'hidden field', 'Dip.emergenza': 'no label', });
