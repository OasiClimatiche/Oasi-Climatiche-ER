...
var map = new ol.Map({
    ...
    view: new ol.View({
        maxZoom: 28,
        minZoom: 1,
        extent: [511463.555983-10000, 4822291.217120, 823787.818667+70000, 5049943.155342],
        projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            //extent: [515000.000000, 4846932.421088, 802000.000000, 4999000.000120],
            units: 'm'
        })
    })
});
...
map.getView().fit([511463.555983, 4822291.217120, 823787.818667, 5049943.155342], map.getSize());
